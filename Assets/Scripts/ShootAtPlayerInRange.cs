...
public class ShootAtPlayerInRange : MonoBehaviour
{
	...
	void Update ()
	{
		Debug.DrawLine (new Vector3 (transform.position.x - this.playerRange, transform.position.y-HeightDiff, transform.position.z), new Vector3 (transform.position.x + this.playerRange, transform.position.y-HeightDiff, transform.position.z));
